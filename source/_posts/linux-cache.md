...
> 我一直认为linux和c/c++能学多深就学多深，因为现在服务器几乎都是linux，而且所有服务器软件都要跑在这个系统上；其次就是，linux暴露给外界就是系统调用，其他语言如果想嵌入内核，就必须封装系统调用接口；而C++主要是锻炼oop思想还有泛型思想；因此，学好了linux和c/c++，再学其他软件会语言，都会轻松很多；
